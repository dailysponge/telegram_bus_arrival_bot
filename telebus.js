...
//         if (diff1 != 0) {
//           data_list.push(
//             `🚍 ${element.ServiceNo}: \t ${diff1}min ${next_bus_seating} \t 2nd 🚍 unavailable`
//           );
//         } else {
//           data_list.push(
//             `🚍 ${element.ServiceNo}: \t now ${next_bus_seating} \t 2nd 🚍 unavailable`
//           );
//         }
//       } else {
//         if (diff1 != 0) {
//           data_list.push(
//             `🚍 ${element.ServiceNo}: \t ${diff1}min ${next_bus_seating} \t ${diff2}min ${subsequent_bus_seating}`
//           );
//         } else {
//           data_list.push(
//             `🚍 ${element.ServiceNo}: \t now ${next_bus_seating} \t ${diff2}min ${subsequent_bus_seating}`
//           );
//         }
//       }
//     }
...
//     bot.sendMessage(
//       chat_id,
//       "Welcome! Im a bus stop bot🤖. Type in bus stop number🚌 to start!\n 🟢= LOW crowd,🟠= MODERATE crowd,🔴= HIGH crowd"
//     );
//   }
...
//     reply_markup: {
//       inline_keyboard: [[{ text: "Update bus stop", callback_data: text_content }]],
//     },
//   });
// });
